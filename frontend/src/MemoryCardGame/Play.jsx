...
import LevelSelectionModal from "../Modals/LevelModal";
import "./Play.css";
...
const Play = () => {
  ...
  const [isOpenLevelModal, setIsOpenLevelModal] = useState(false);
  ...
  return (
    ...
    >
      ...
      {/* level selection modal component */}
      <LevelSelectionModal
        isOpenModal={isOpenLevelModal}
        handleClose={handCloseLevelModal}
